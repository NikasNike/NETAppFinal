...
public class NetMQClient : IMessageSourceClient
{
    ...
    class Program
    {
        ...
        {
            NetMQClient client = new NetMQClient("tcp://localhost:1324");
            client.Connect("tcp://localhost:1324");

            Console.WriteLine("Соединение установлено///Введите exit для выхода.");
